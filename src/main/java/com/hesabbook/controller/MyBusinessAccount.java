...
import com.hesabbook.service.account.AccountDetailsService;
...
@RestController
@RequestMapping("/hesabbook/business/account")
public class MyBusinessAccount {
    ...
    public BusinessResponse getAllMangeUser() {
        ...
        List<AccountDetails> accountDetailResponse = accountDetailsService.findAll();
    ...
    public BusinessResponse findByPrimaryUserId(@PathVariable("id") String id) {
        BusinessResponse businessResponse = new BusinessResponse();
        List<AccountDetails> accountDetailResponse = accountDetailsService.findByPrimaryUserId(id);
        businessResponse.setCode(200);
        businessResponse.setStatus("SUCCESS");
        businessResponse.setResponse(accountDetailResponse);
        return businessResponse;
    ...
    @PostMapping("/save")
    public BusinessResponse saveManageUser(@RequestBody AccountDetails accountDetails) {
        BusinessResponse businessResponse = new BusinessResponse();
        AccountDetails accountDetailResponse = accountDetailsService.save(accountDetails);
        businessResponse.setCode(200);
        businessResponse.setStatus("SUCCESS");
        businessResponse.setResponse(accountDetailResponse);
        return businessResponse;
